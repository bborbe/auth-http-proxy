...
- Bumps Go from 1.26.2 to 1.26.3 (stdlib CVEs GO-2026-4918, GO-2026-4971, GO-2026-4980, GO-2026-4982)
- Resolves Dependabot go-git advisory for bborbe/auth-http-proxy
...
Current Go: 1.26.2 in `go.mod` and `Dockerfile`.
...
2. Bump Go version 1.26.2 → 1.26.3 (patches stdlib CVEs GO-2026-4918, GO-2026-4971, GO-2026-4980, GO-2026-4982):
